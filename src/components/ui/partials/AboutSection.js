        ...
        <Grid item>
          <Grid className={classes.gridItemContainer} container item direction="column" align="center" justify="center">
            {/* <Grid item direction="column" alight="center" justify="center"> */}
              ...
              <Grid item><Link to={detailsLink}><Button variant="outlined" style={{"color": iconColor, "borderColor": iconColor}}>Traditional CV</Button></Link></Grid>
              <Grid item><a href={gitHubUrl}><LinkedInIcon fontSize="large" style={{"color": iconColor}}/></a></Grid>
              </Grid>
            {/* </Grid> */}
          </Grid>
        </Grid>
