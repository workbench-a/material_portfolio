      ...
      <Box className={classes.section} style={{"backgroundColor": bgColor, "height": "0rem"}} display="flex" justifyContent="center" alignItems="start">
        ...
        >
          ...
          <Typography gutterBottom variant="h4" component="h2">
            ...
            A running record of my work.
            </Typography>
            {/* <Typography Wrap variant="body2" color="textPrimary" component="p" justifyContent="center">
            A running list of news blogs, comunities, researchers, conferences, events, and other research and industry related information pertaining to machine learning and artificial intelligence.
            </Typography> */}
          </Grid>
        </Grid>
      </Box>
